...
#define CEPH_FS_FEATURE_INCOMPAT_GHOBJECT CompatSet::Feature(1, "Erasure Coding Support")
...
public:
  ...
  int lfn_link(coll_t c, coll_t cid, const ghobject_t& oid) ;
  int lfn_unlink(coll_t cid, const ghobject_t& oid, const SequencerPosition &spos);
